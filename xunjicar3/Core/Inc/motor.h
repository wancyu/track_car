#ifndef __MOTOR_H // 建议用双下划线，标准做法
#define __MOTOR_H

#include "stm32f4xx_hal.h"
#include "pid.h"

//pos，speed，rps，turns，pwm_duty这些物理量是随时可以查看的
//而目标值只有设置了那一项才能查看
...
// ====================================================================
// 基础物理参数定义：MG513P30-12V 电机参数
// ====================================================================
#define MOTOR_RATED_RPM          300.0f  // 额定输出转速约 300 RPM
#define ENCODER_REDUCTION_RATIO  30.0f   // 减速比：1:30
#define ENCODER_PPR              500.0f  // 编码器线数：500线

// 轮子转一圈总脉冲数：500 * 4 * 30 = 60000.0f
#define ENCODER_TOTAL_PPR        (ENCODER_PPR * 4.0f * ENCODER_REDUCTION_RATIO)

// 电机物理极限最大转速 (转/秒)：300.0f / 60.0f = 5f r/s
#define MOTOR_MAX_RPS            (MOTOR_RATED_RPM / 60.0f)
// 硬件 速度 最大限制  10ms 中断内硬件速度反馈(delta)的最大理论值 5.0 * (60000.0 / 100.0) = 3000.0f
...
// #define MOTOR_SPEED_KP           30.0f   // 比例系数
// #define MOTOR_SPEED_KI           1.5f   // 积分系数
...
typedef struct {
    ...
    float               speed_target;      //目标速度，已在PID_TypeDef定义
