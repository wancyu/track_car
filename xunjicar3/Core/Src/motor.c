 ...
 * @param  port1: 电机方向引脚1 (如 AIN1)
 * @param  pin1: 电机方向引脚1 (如 AIN1)
 * @param  port2: 电机方向引脚2 (如 AIN2)
 * @param  pin2: 电机方向引脚1 (如 AIN1)
 * @param  pwm_tim: PWM输出定时器及通道
 * @param  channel: 电机方向引脚1 (如 AIN1)
